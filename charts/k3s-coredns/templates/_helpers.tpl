...
Common labels
*/}}
{{- define "k3s-coredns.labels" -}}
app.kubernetes.io/managed-by: {{ .Release.Service | quote }}
app.kubernetes.io/instance: {{ .Release.Name | quote }}
helm.sh/chart: "{{ .Chart.Name }}-{{ .Chart.Version | replace "+" "_" }}"
{{- if .Values.isClusterService }}
k8s-app: {{ template "k3s-coredns.k8sapplabel" . }}
kubernetes.io/cluster-service: "true"
kubernetes.io/name: "CoreDNS"
{{- end }}
app.kubernetes.io/name: {{ template "k3s-coredns.name" . }}
{{- end -}}

{{/*
Common labels with autoscaler
*/}}
{{- define "k3s-coredns.labels.autoscaler" -}}
app.kubernetes.io/managed-by: {{ .Release.Service | quote }}
app.kubernetes.io/instance: {{ .Release.Name | quote }}
helm.sh/chart: "{{ .Chart.Name }}-{{ .Chart.Version | replace "+" "_" }}"
{{- if .Values.isClusterService }}
k8s-app: {{ template "k3s-coredns.k8sapplabel" . }}-autoscaler
kubernetes.io/cluster-service: "true"
kubernetes.io/name: "CoreDNS"
{{- end }}
app.kubernetes.io/name: {{ template "k3s-coredns.name" . }}-autoscaler
{{- end -}}

{{/*
Allow k8s-app label to be overridden
*/}}
{{- define "k3s-coredns.k8sapplabel" -}}
...
*/}}
{{- define "k3s-coredns.servicePorts" -}}
...
Generate the list of ports automatically from the server definitions
*/}}
{{- define "k3s-coredns.containerPorts" -}}
    {{/* Set ports to be an empty dict */}}
    {{- $ports := dict -}}
    {{/* Iterate through each of the server blocks */}}
    {{- range .Values.servers -}}
...
*/}}
{{- define "k3s-coredns.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "k3s-coredns.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
